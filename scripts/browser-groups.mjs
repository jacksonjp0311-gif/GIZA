...
const groups={core:['layers','startup-camera','viewport-drawers','centered-orbit'],evidence:['evidence-workflow'],atlas:['atlas-expansion'],guidance:['source-campaign','tutorial']};
